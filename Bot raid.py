print("Welcome to the official set-up guide to Sweet Moon bot nuker.\n")
import os
import random
import colorama
...
prefix = input("prefix:")                                                       #
token = input("TOKEN:")                                            #
spam_messages = input("Spam message:")       #
massdm = "Currently broken.."                    #
rolenames = input("Role Names To Spam:")         #                                                            
channels = input("Channels To Spam Names:")  #
##############################
...
async def on_ready():
    ...
    print(f'''{Fore.CYAN}
   _____                   __     __  ___
  / ___/      _____  ___  / /_   /  |/  /___  ____  ____ 
  \__ \ | /| / / _ \/ _ \/ __/  / /|_/ / __ \/ __ \/ __ |
 ___/ / |/ |/ /  __/  __/ /_   / /  / / /_/ / /_/ / / / /
/____/|__/|__/\___/\___/\__/  /_/  /_/\____/\____/_/ /_/ 

------------------------------------------------------------------ Nuker Is Online <$
    ''' + Fore.RESET)
    print("prefix:",(prefix))
    print("spam msg:",(spam_messages))
    print("roles name spam:",(rolenames))
    print("channel name:",(channels))
    print("To show command type: (Yourprefix)help")
#help commamd
@bot.command()
async def help(ctx):
        await ctx.message.delete()
        embed = discord.Embed(color=000000, timestamp=ctx.message.created_at)
        embed.set_author(name=" 🌠 Sweet Moon Developer")
